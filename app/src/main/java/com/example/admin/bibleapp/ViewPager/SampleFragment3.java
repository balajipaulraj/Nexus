...
import android.os.Handler;import androidx.core.view.ViewCompat;
...
public class SampleFragment3 extends Fragment {
    ...
    class C02581 extends WebViewClient {
        ...
        class C02571 implements Runnable {
            ...
            public void run() {
                int contentHeight = SampleFragment3.this.wvContent.getContentHeight();
                int viewHeight = SampleFragment3.this.wvContent.getHeight();
            }
        }
...
//            lv_content.setBackgroundColor();
    ...
    public class JavaScriptInterface {
        ...
        class C02671 implements Runnable {
            ...
            public void run() {
                Toast.makeText(SampleFragment3.this.getActivity(), "Reset Completed", Toast.LENGTH_LONG).show();
            }
        }
    ...
    class C05032 implements SelectionListener {
        ...
        class C02591 implements Runnable {
            ...
            public void run() {
                SampleFragment3.this.option.setVisibility(View.VISIBLE);
                SampleFragment3.this.option.setAnimation(SampleFragment3.this.fabOpen);
            }
        }
        ...
        public void selectionChanged(String text) {
            SampleFragment3.this.mSelectedText = text;
            SampleFragment3.this.getActivity().runOnUiThread(new C02591());
        }

        public void endSelection() {
            View v = new View(SampleFragment3.this.getActivity());
        }
    }
...
//        this.wvContent.setWebViewClient(new C02581());
        if (this.bundle != null) {
            this.value = bundle.getStringArrayList("frag3");
            this.title = bundle.getString("title3", null);
            this.newread = bundle.getString("newread", null);
        }
...
//                    lv_content.getPositionForView(view);
    ...
    private void search(String mSelectedText) {
        if (this.pop_search_word == null) {
          ...
          //  ivclose.setOnClickListener(new SampleFragment3.C02636( ));
            ...
            btnCancel.setOnClickListener(new SampleFragment3.C02669( ));
