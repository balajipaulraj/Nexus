...
public class SampleFragment4 extends Fragment {
    ...
    class C02581 extends WebViewClient {
        ...
        class C02571 implements Runnable {
            ...
            public void run() {
                int contentHeight = SampleFragment4.this.wvContent.getContentHeight();
                int viewHeight = SampleFragment4.this.wvContent.getHeight();
            }
        }
...
//            lv_content.setBackgroundColor();
    ...
    public class JavaScriptInterface {
        ...
        class C02671 implements Runnable {
            ...
            public void run() {
                Toast.makeText(SampleFragment4.this.getActivity(), "Reset Completed", Toast.LENGTH_LONG).show();
            }
        }
    ...
    class C05032 implements SelectionListener {
        ...
        class C02591 implements Runnable {
            ...
            public void run() {
                SampleFragment4.this.option.setVisibility(View.VISIBLE);
                SampleFragment4.this.option.setAnimation(SampleFragment4.this.fabOpen);
            }
        }
        ...
        public void selectionChanged(String text) {
            SampleFragment4.this.mSelectedText = text;
            SampleFragment4.this.getActivity().runOnUiThread(new C02591());
        }

        public void endSelection() {
            View v = new View(SampleFragment4.this.getActivity());
        }
    }
...
//        this.wvContent.setWebViewClient(new C02581());
        if (this.bundle != null) {
            this.value = bundle.getStringArrayList("frag4");
            this.title = bundle.getString("title4", null);
            this.fourthread = bundle.getString("fourthread", null);
        }
...
//                    lv_content.getPositionForView(view);
    ...
    private void search(String mSelectedText) {
        if (this.pop_search_word == null) {
          ...
          //  ivclose.setOnClickListener(new SampleFragment4.C02636( ));
            ...
            btnCancel.setOnClickListener(new SampleFragment4.C02669( ));
