...
public class SampleFragment2 extends Fragment {
    ...
    class C02581 extends WebViewClient {
        ...
        class C02571 implements Runnable {
            ...
            public void run() {
                int contentHeight = SampleFragment2.this.wvContent.getContentHeight( );
                int viewHeight = SampleFragment2.this.wvContent.getHeight( );
            }
        }
...
//            lv_content.setBackgroundColor();
    ...
    public class JavaScriptInterface {
        ...
        class C02671 implements Runnable {
            ...
            public void run() {
                Toast.makeText(SampleFragment2.this.getActivity( ), "Reset Completed", Toast.LENGTH_LONG).show( );
            }
        }
    ...
    class C05032 implements SelectionListener {
        ...
        class C02591 implements Runnable {
            ...
            public void run() {
                SampleFragment2.this.option.setVisibility(View.VISIBLE);
                SampleFragment2.this.option.setAnimation(SampleFragment2.this.fabOpen);
            }
        }
        ...
        public void selectionChanged(String text) {
            SampleFragment2.this.mSelectedText = text;
            SampleFragment2.this.getActivity( ).runOnUiThread(new C02591( ));
        }

        public void endSelection() {
            View v = new View(SampleFragment2.this.getActivity( ));
        }
    }
...
//        this.wvContent.setWebViewClient(new C02581());
        if (this.bundle != null) {
            this.value = bundle.getStringArrayList("frag2");
            this.title = bundle.getString("title2", null);
            this.psalmread = bundle.getString("psalmread", null);
        }
